...
- OOD：8 轮推理时，正常输入尺度的 MSE 为 0.00704，输入尺度扩大到 3 倍后为 5.14531；斜协方差为 0.02290。32 轮对应的三个值是 0.06194、4.71575、0.07826。标签噪声也使误差上升。见 [`8 轮 OOD 结果`](results/main/ood_8.json) 和 [`32 轮 OOD 结果`](results/main/ood.json)；仓库中原有的 OOD 图展示 32 轮结果。
